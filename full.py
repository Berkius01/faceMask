...
while True:
    ...
    #mpDraw.draw_landmarks(img,results.right_hand_landmarks,mpHolistic.HAND_CONECTIONS,drawing_specs,drawing_specs)
    #mpDraw.draw_landmarks(img,results.pose_landmarks,mpHolistic.POSE_CONTOURS,drawing_specs,drawing_specs)
